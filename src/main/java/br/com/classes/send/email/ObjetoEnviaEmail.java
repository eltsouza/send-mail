...
{
	private String userName = "souzaconsuloria@gmail.com"; //informar seu email remetente
	private String senha= "java@1985"; // informar sua senha
    private String listaDestinatarios = "";
    private String nomeRemetente ="";
    private String assuntoEmail = "";
    private String textoEmail  = "";
	
    //criando construtor para receber os parametros e executar o envio do email
	...
	public void enviarEmail(boolean envioHtml) {
			...
			try {
			    ...
			    properties.put("mail.smtp.ssl.trust","*");// faz a altenticação
				...
				Address[] toUser = InternetAddress.parse(listaDestinatarios); // lista de emails destinatários
	 ...
	 * 
	 * Retorn um PDF com o texto do Paragrafo de exemplo.
	 * */
